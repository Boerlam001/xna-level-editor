...
namespace EditorModel
{
    ...
    public class DebugDrawer : Jitter.IDebugDrawer
    {
        ...
        public DebugDrawer(GraphicsDevice graphicsDevice, Camera camera)
        {
        ...
        public void DrawLine(JVector p0, JVector p1, Color color)
        {
            ...
            LineList[lineIndex - 2].Position = Helper.ToXNAVector(p0);

            LineList[lineIndex - 1].Color = color;
            LineList[lineIndex - 1].Position = Helper.ToXNAVector(p1);
        }
        ...
        public void DrawTriangle(JVector p0, JVector p1, JVector p2, Color color)
        {
            ...
            TriangleList[triangleIndex - 2].Position = Helper.ToXNAVector(p0);

            TriangleList[triangleIndex - 1].Color = color;
            TriangleList[triangleIndex - 1].Position = Helper.ToXNAVector(p1);

            TriangleList[triangleIndex - 3].Color = color;
            TriangleList[triangleIndex - 3].Position = Helper.ToXNAVector(p2);
        }
