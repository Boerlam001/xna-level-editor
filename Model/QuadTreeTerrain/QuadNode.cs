        ...
        private void AddVertices()
        {
            switch (NodeType)
            {
                ...
                default:
                    ...
                    {
                        Activated = true,
                        Index = (short)(VertexTopLeft.Index + _nodeSize)
                    };

                    VertexBottomLeft = new QuadNodeVertex
                    {
                        Activated = true,
                        Index = (short)((_parentTree.TopNodeSize + 1) * _parentTree.TopNodeSize)
                    };

                    VertexBottomRight = new QuadNodeVertex
                    {
                        Activated = true,
                        Index = (short)(VertexBottomLeft.Index + _nodeSize)
                    };
            ...
            {
                Activated = false,
                Index = (short)(VertexTopLeft.Index + (_nodeSize / 2))
            };

            VertexLeft = new QuadNodeVertex
            {
                Activated = false,
                Index = (short)(VertexTopLeft.Index + (_parentTree.TopNodeSize + 1) * (_nodeSize / 2))
            };

            VertexCenter = new QuadNodeVertex
            {
                Activated = false,
                Index = (short)(VertexLeft.Index + (_nodeSize / 2))
            };

            VertexRight = new QuadNodeVertex
            {
                Activated = false,
                Index = (short)(VertexLeft.Index + _nodeSize)
            };

            VertexBottom = new QuadNodeVertex
            {
                Activated = false,
                Index = (short)(VertexBottomLeft.Index + (_nodeSize / 2))
            };
        }
